import style from "../AnimaisPerdidos/AnimaisPerdidos.module.css";
...
import animaisAPI from "../../services/animaisAPI"; // Ajuste o caminho do serviço de animais

export function AnimaisPerdidos() {
    ...
    async function carregarAnimais() {
        try {
            const listarAnimais = await animaisAPI.listarAnimaisAsync(false);
            setAnimais(listarAnimais);

            // Extrair as espécies únicas
            const especiesUnicas = [...new Set(listarAnimais.map(animal => animal.especie))].sort();
            ...
            <Topbar>
                <div className={style.pagina_conteudo}>
                    <div className={style.pagina_cabecalho}>
                        ...
                        <Link to="/animais" className={style.botao_novo_usuario}>
                            Incluir
                        </Link>
                    </div>
